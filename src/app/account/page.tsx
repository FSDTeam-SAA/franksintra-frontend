          ...
          <div className="space-y-6">
            <Card className="overflow-hidden rounded-[1.75rem] border-slate-200 bg-white shadow-sm">
              <CardHeader className="border-b border-slate-100 bg-[linear-gradient(135deg,_#f8fbff_0%,_#eef4ff_100%)]">
                ...
                <CardTitle className="mt-3 text-2xl">Profile Settings</CardTitle>
                <CardDescription className="max-w-xl text-sm leading-6 sm:text-[15px]">
                  Keep your personal details, gender, and language preference updated.
                </CardDescription>
              </CardHeader>
                ...
                {profileQuery.isLoading ? (
                  ...
                  <form onSubmit={handleUpdateProfile} className="space-y-5">
                    <div className="grid gap-4 sm:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="username" className="flex items-center gap-1.5 text-sm font-semibold text-slate-700">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="dob" className="flex items-center gap-1.5 text-sm font-semibold text-slate-700">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="phone" className="flex items-center gap-1.5 text-sm font-semibold text-slate-700">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="gender" className="flex items-center gap-1.5 text-sm font-semibold text-slate-700">
                          <UsersRound className="h-4 w-4 text-slate-400" /> Gender
                        </Label>
                        <select
                          id="gender"
                          value={gender}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="bio" className="flex items-center gap-1.5 text-sm font-semibold text-slate-700">
                    ...
                    <div className="border-t border-slate-100 pt-5 mt-6">
                      <h3 className="text-base font-semibold text-slate-800 flex items-center gap-2 mb-4">
                        <MapPin className="h-5 w-5 text-[#4285F4]" /> Address Details
                      </h3>

                      <div className="grid gap-4 sm:grid-cols-2">
                        <div className="space-y-2">
                          <Label htmlFor="roadArea" className="text-sm font-semibold text-slate-700">Road / Area</Label>
                          <Input
                            id="roadArea"
                            type="text"
                            value={roadArea}
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="cityState" className="text-sm font-semibold text-slate-700">City / State</Label>
                          <Input
                            id="cityState"
                            type="text"
                            value={cityState}
        ...
        <DialogContent className="max-w-md p-6 bg-white border border-slate-200 shadow-xl rounded-2xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-slate-500 text-sm mt-2">
              Are you sure you want to log out from your account? You will need to log back in to manage your website workspace or edit settings.
            </DialogDescription>
          </DialogHeader>
